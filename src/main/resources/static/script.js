    ...
    $('#main td textarea').click(function (event) {
        switch (true) {
            ...
            case $(event.target).is('#second'):
                $('#cell2').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell2").offset().top) - $(window).height() / 4}, 500);
                break;

            case $(event.target).is('#third'):
                $('#cell3').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell3").offset().top) - $(window).height() / 4}, 500);
                break;

            case $(event.target).is('#fourth'):
                $('#cell4').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell4").offset().top) - $(window).height() / 4}, 500);
                break;
            ...
            case $(event.target).is('#fifth'):
                $('#cell5').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell5").offset().top) - $(window).height() / 4}, 500);
                break;

            case $(event.target).is('#sixth'):
                $('#cell6').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell6").offset().top) - $(window).height() / 4}, 500);
                break;

            case $(event.target).is('#seventh'):
                $('#cell7').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell7").offset().top) - $(window).height() / 4}, 500);
                break;

            case $(event.target).is('#eighth'):
                $('#cell8').css('opacity', '1');
                $("html, body").animate({scrollTop: ($("#cell8").offset().top) - $(window).height() / 4}, 500);
                break;
        }
    });
